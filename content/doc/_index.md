...
由于智交和智科在大一的课程差异不大，因此将两个专业的大一课程单独列出来。同时因为智工近年课程调整较大，有的课程可能已经废弃，储存在往届课程中，有的课程调整了所在学期，目前本项目以维护者所在的 **24 级**组织，如果未来有新的变化，可以根据新一届学生的课程设置组织。也欢迎同学们前往[贡献方式](https://openise.pages.dev/about/)中提 Issue 来告知维护者每届的课程变化。

全部课程复习策略整理是将所有复习资料汇总而来，以防有人只需要阅读复习建议。

## 涵盖内容及贡献范围

本项目目标是涵盖智能工程学院开设的所有课程内容的**复习资料、课程简介、复习建议和选课建议**。目前集齐的比较多的是大部分课程的复习资料，但是课程简介、复习建议和选课建议这几个比较缺乏，因此如果你有**任何想提交的课程简介、复习建议和选课建议**，欢迎到[贡献方式](https://openise.pages.dev/about/)中通过 PR 或者邮箱的方式来贡献。
...
我们同样欢迎高年级同学或校友以[贡献者](https://openise.pages.dev/about/)身份分享个人经历与见解——无论是学业规划、保研或出国的经验，还是 AI 时代下的技能转型思考，都是对低年级同学极具参考价值的内容。
